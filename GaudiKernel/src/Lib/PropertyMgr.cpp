...
PropertyMgr::PropertyMgr ( const PropertyMgr& right )  
  : IInterface(right), IProperty(right)
...
// =====================================================================
StatusCode PropertyMgr::queryInterface
( const InterfaceID& iid        ,  
  void**             pinterface ) 
{ 
  // invalid destination
  if ( 0 == pinterface ) { return StatusCode::FAILURE ; }
  
  if      ( IInterface ::interfaceID () == iid ) 
  { *pinterface = static_cast<IInterface*> ( this ) ; } 
  else if ( IProperty  ::interfaceID () == iid ) 
  { *pinterface = static_cast<IProperty*>  ( this ) ; }
  else if ( 0 != m_pOuter ) // get the interface from the hub
  { return m_pOuter->queryInterface(iid, pinterface) ; }   // RETURN 
...
// =====================================================================
unsigned long PropertyMgr::addRef() { return ++m_refcount; }
// =====================================================================
// Implementation of IInterface::release
// =====================================================================
unsigned long PropertyMgr::release() 
{
