...
public:
  ...
  */
  ...
  virtual long numberOfObjects() const   {  return m_sequential.size();       }
   ...
   */
  virtual long containedObjects(std::vector<ContainedObject*>& v) const;
  //@}
...
// Retrieve the full content of the object container.
template <class DATATYPE, class MAPPING> inline
long KeyedContainer<DATATYPE, MAPPING>::containedObjects
