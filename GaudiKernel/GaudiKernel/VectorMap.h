...
namespace GaudiUtils 
{
  ...
  public:
     ...
     *  The actual structure used to compare the elemenents
  ...
  public:
     ...
     *  With the right guess the method could be  moure efficient
     *  @attention there is no replacement for the existing element!
     ...
     *  @attention there is no replacement for the existing element!
     *  @param  pos    the guess about position where to insert the element
     *  @param  key    key value to te inserted 
     *  @param  mapped value to be associated with the key 
     *  @return position of the inserted elements with the flag 
     *          which indicated the actual insertion
     */
     ...
     *  overwrite the exising mapped value.
     *
     ...
     *  @return the position of the inserted or modified element 
     */
    iterator update 
    ( const key_type&    key    ,
      const mapped_type& mapped )
     ...
     *
     *  @attention The behaviour different from std::map, 
  ...
  public:
     ...
     *  @param cmp comparision criteria for the key 
