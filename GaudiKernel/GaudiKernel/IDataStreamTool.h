...
static const InterfaceID IID_IDataStreamTool ( "IDataStreamTool", 1, 0 );
...
class IDataStreamTool : virtual public IAlgTool {
public: 
  ...
  static const InterfaceID& interfaceID() { return IID_IDataStreamTool; }
