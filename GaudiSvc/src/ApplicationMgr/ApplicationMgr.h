// $Header: /tmp/svngaudi/tmp.jEpFh25751/Gaudi/GaudiSvc/src/ApplicationMgr/ApplicationMgr.h,v 1.32.4.2 2008/08/18 16:52:02 leggett Exp $	//
...
public:
  ...
  virtual const std::string& stateName()  const;
...
protected:
  ...
  VectorName          m_stateName;          ///< Vector is State Names
