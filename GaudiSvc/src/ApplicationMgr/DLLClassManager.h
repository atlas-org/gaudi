...
//              declarating dynamic libraries containg concrete class factories).
//
// Author:      Pere Mato
//
class DLLClassManager : virtual public  IClassManager  {
public:
  // default creator
...
private:
  ...
  IAlgManager*  m_algmanager;  // Algorithm manager reference
  ISvcManager*  m_svcmanager;  // Service manager reference
  ICnvManager*  m_cnvmanager;  // Converter manager reference
  IObjManager*  m_objmanager;  // Manager reference for factories not beeing algs, cnvs or svcs
  IMessageSvc*  m_msgsvc;      // Message Service reference
