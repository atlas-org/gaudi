...
namespace HepRndm  {
  ...
  ************************************************************************/
  ...
  template <> double Generator<Rndm::Landau>::shoot()    const     {
