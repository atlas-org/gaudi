...
/**@class PartitionSwitchAlg 
  ...
  * @version: 1.0
  */
class PartitionSwitchAlg : public Algorithm, virtual public IPartitionControl {
...
public:
  ...
  :	Algorithm(name, pSvcLocator), m_actor(0)
  {
  ...
  virtual STATUS queryInterface(const InterfaceID& riid, void** ppvUnknown) {
    if ( IPartitionControl::interfaceID().versionMatch(riid) )
      *ppvUnknown = (IPartitionControl*)this;
      ...
      return Algorithm::queryInterface(riid, ppvUnknown);
    addRef();
    return SUCCESS;
  }
