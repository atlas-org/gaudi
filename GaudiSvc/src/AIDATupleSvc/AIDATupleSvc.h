...
class AIDATupleSvc : public DataSvc,
                     virtual public IAIDATupleSvc
{
private:
...
public:
  ...
  /** Set a selection critiria for reading, as a filter
  ...
  /// Return the store (file) name corresponding to a tuple
  //virtual std::string storeName(AIDA::ITuple*& tObj);
};
