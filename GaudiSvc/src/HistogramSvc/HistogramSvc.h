 ...
 *
 */
class HistogramSvc : public DataSvc, 
                     virtual public IHistogramSvc,
...
private:  
  ...
  void not_implemented()  const {
    ...
    log << MSG::ERROR << "Sorry, not yet implemented..." << endreq;
  }
protected:
...
public:
  ...
  /** Query the interface
   *  @param iid requested interface ID
   *  @param ppv pointer to requested interface
   */
