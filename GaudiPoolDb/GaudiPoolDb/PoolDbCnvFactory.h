...
// Interface ID ( interface id, major version, minor version) 
static const InterfaceID IID_IPoolDbCnvFactory("IPoolDbCnvFactory", 2 , 0); 
...
/** @class IPoolDbCnvFactory PoolDbCnvFactory.h PoolDb/PoolDbCnvFactory.h
  ...
  * @version 1.0
  */
class IPoolDbCnvFactory : virtual public IInterface   {
public:
  /// Retrieve interface ID
  static const InterfaceID& interfaceID() { return IID_IPoolDbCnvFactory; }
...
class PoolDbCnvFactory : virtual public ICnvFactory,
                         virtual public IPoolDbCnvFactory   
{
  /// Object type name
...
public:
  ...
  virtual StatusCode queryInterface(const InterfaceID& riid, void** ppISvc)   {
	  if ( IID_IPoolDbCnvFactory == riid )   {
      *ppISvc = (IPoolDbCnvFactory *) this;
    }
	  else if( IID_ICnvFactory == riid )    {
        *ppISvc = (ICnvFactory*) this;
    }
