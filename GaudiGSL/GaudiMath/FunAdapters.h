...
namespace Genfun 
{
  ...
  { 
    ...
    class AdapterIFunction : public AbsFunction
    {
    public:
     ...
     *  
     *  // evaluate the fuinction in point (1,2):
     *  Argument arg(2) ;
     *  arg[0] = 1 ; 
     *  arg[1] = 2 ;
     *
     ...
     */
    // ========================================================================
    class Adapter2DoubleFunction : public AbsFunction
    {
    public:
     ...
     *  const AbsFuction& fun = Adapter2DoubleFunction( fun ) ;
     *  
     *  // evaluate the fuinction in point (1,2,3):
     *  Argument arg(3) ;
     *  arg[0] = 1 ; 
     *  arg[1] = 2 ;
     *  arg[2] = 3 ;
     ...
     */
    // ========================================================================
    class Adapter3DoubleFunction : public AbsFunction
    {
    public:
      /// the actual type of the function "to be adapted"
      typedef double (*Function)( const double , 
     ...
     */
    // ========================================================================
    class SimpleFunction : public AbsFunction 
    {
    public:
