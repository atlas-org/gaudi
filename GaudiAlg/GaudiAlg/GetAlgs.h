...
namespace Gaudi
{
  ...
  {   
     ...
     *  @date 2007-09-07
     */
    GaudiAlgorithm* getGaudiAlg       ( const IAlgContextSvc* svc ) ;
    // ========================================================================
    /** simple function to extract the last active
     ...
     *  @date 2007-09-07
     */
    GaudiHistoAlg*  getHistoAlg       ( const IAlgContextSvc* svc ) ;
    // ========================================================================
    /** simple function to extract the last active
     ...
     *  @date 2007-09-07
     */
    GaudiTupleAlg*  getTupleAlg       ( const IAlgContextSvc* svc ) ;
    // ========================================================================
    /** simple function to extract the last active
     ...
     *  @date 2007-09-07
     */
    GaudiSequencer* getGaudiSequencer ( const IAlgContextSvc* svc ) ;
    // ========================================================================
    /** simple function to extract the last active
     ...
     *  @date 2007-09-07
     */
    Sequencer*      getSequencerAlg   ( const IAlgContextSvc* svc ) ;
    // ========================================================================
    /** simple function to extract the last active
     ...
     *  @date 2007-09-07
     */
    IAlgorithm*     getSequencer      ( const IAlgContextSvc* svc ) ;
    // ========================================================================
