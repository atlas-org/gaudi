...
// ============================================================================
/** @file
 *  Colelction fo few 'technical' methods for instatiation of tuples 
 *  @author Ivan BELYAEV
 *  @date   2004-01-27
 */
// ============================================================================
...
namespace Tuples
{
  ...
  {  
    /** @class TupleObjImp
     *
     *  The simplest concrete implementationof class TupleObj 
     ...
     *  which suports member functions Erorr and Warning     
     ...
     *  
     *  Few concrete error handlers for dealing with classes, 
     *  which suports member functions Erorr,Warning and Print 
     *   ( e.g. class GaudiAlgorithm or class GaudiTool ) 
     *  are provided 
     *
     * @author Vanya BELYAEV Ivan.Belyaev@itep.ru
